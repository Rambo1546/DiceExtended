...
import org.w3c.dom.css.Counter;
	...
	public class Dice {
		public static void main(String[] args){
		   ...
		   if (UserPick == Dice2)
			   System.out.printf("You are correct the number was %d and you played %d times.",Dice2,Count);
			
		   else if(Dice2 != UserPick)
				System.out.printf("You were wrong the number was % and you played %d times .", Dice2,Count);
